...
tags: []
coverImage: "/images/articles/rails-n-plus-one-joins-includes-preload-eager-load/rails-n-plus-one-cover.png"
---
...
![customerOrders](/images/articles/rails-n-plus-one-joins-includes-preload-eager-load/customer-orders.png)
```ruby
# customer.rb
...
![fourCustomerOrders](/images/articles/rails-n-plus-one-joins-includes-preload-eager-load/four-customer-orders.png)
```ruby
...
![customerLeftJoin](/images/articles/rails-n-plus-one-joins-includes-preload-eager-load/customer-left-join.png)
